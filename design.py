...
Borealis = [ "Borealis", "#01EFAC", "#01CBAE", "#2082A6", "#524094", "#562A83" ]
BluePlanet1 = [ "BluePlanet1", "#2297FA", "#50B6FE", "#7ED8FA", "#94AEFE", "#8082D6" ]
Oasis = [ "Oasis", "#23570D", "#367C28", "#86B06B", "#BAD5EC", "#6BA2DE" ]
...
my_canvas.rect(design_x + 3 * width, design_y, width, height, fill = 1)
my_canvas.setFillColor(HexColor(Oasis[5]))
my_canvas.rect(design_x + 4 * width, design_y, width, height, fill = 1)
