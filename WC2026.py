...
for j in range(13):   
    ...
    if j == 11:
        ...
        my_canvas.rect(left_margin, line + categoryrectdy, 4 * colwidthgame, categoryrectheight, stroke = 1, fill = 1)
        my_canvas.setFillColor(HexColor("#ffffff"))
        my_canvas.drawString(left_margin + 1.0, line + categorystrdy, "Quarter finals")
        my_canvas.setFillColor(HexColor(designcolors[1]))
        my_canvas.rect(left_margin + 4 * colwidthgame, line + categoryrectdy, 2 * colwidthgame, categoryrectheight, stroke = 1, fill = 1)
        my_canvas.setFillColor(HexColor("#ffffff"))
        ...
        my_canvas.rect(left_margin + 6 * colwidthgame, line + categoryrectdy, 1 * colwidthgame, categoryrectheight, stroke = 1, fill = 1)
        my_canvas.setFillColor(HexColor("#ffffff"))
        ...
        my_canvas.rect(left_margin + 7 * colwidthgame, line + categoryrectdy, 1 * colwidthgame, categoryrectheight, stroke = 1, fill = 1)
        my_canvas.setFillColor(HexColor("#ffffff"))
