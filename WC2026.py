...
for j in range(13):
    if j % 2 == 0:
        ...
        mode = "r"
    drawHorizontalRect(my_canvas, left_margin, gameline - 3.5 - j * rowheightgame, 8 * colwidthgame, rowheightgame, mode)
...
for j in range(13):
    ...
    for i in range(8):
        ...
        my_canvas.circle(left_margin + i * colwidthgame + 17.5, gameline + 0.16, 2.0, stroke = 0, fill = 1)
        calindex += 1
