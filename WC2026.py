...
for i in range(48):
    ...
    drawing = scaleSVG("Flags/" + nationsdata[teamcounter][8] + "tw.svg", 0.25)
    renderPDF.draw(drawing, my_canvas, lx + 7, ly - i * legendarowheight)
    my_canvas.setFillColor(HexColor("#000000"))
    my_canvas.drawString(lx + 27, ly + 2.0 - i * legendarowheight, nationsdata[teamcounter][0])
    ...
    if nationcolor == "#ffffff":
        ...
        if colorindex >= 0:
            ...
            my_canvas.setFillColor(HexColor("#000000"))
    my_canvas.circle(lx + 25, ly + 4.0 - i * legendarowheight, 2.0, stroke = 0, fill = 1)
