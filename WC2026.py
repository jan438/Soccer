...
mapversie = "Russia"
colwidthgame = 72
pcol1 = HexColor("#9FA5D5") # lighter blue
pcol2 = HexColor("#E8F5C8") # lighter green
ccol1 = HexColor("#9e9e9e") # dark gray
ccol2 = HexColor("#b0b0b0") # light gray
lcol1 = HexColor("#9e9e9e") # legenda dark green
lcol2 = HexColor("#b0b0b0") # legenda light green
rowheightgame = 18
gameline = 550
legendawidth = 75
legendarowheight = 10
...
for i in range(48):
    ...
    if cadre_pouleland:
        my_canvas.setFillColor(HexColor("#c5c5c5"))
        my_canvas.rect(lx + 6, ly - i * legendarowheight, 12, 10, stroke = 1, fill = 1)
    legendascaling = float(nationsdata[teamcounter][10])
    if legendascaling == 0:
        ...
        drawing = scaleSVG("Logos/" + nationsdata[teamcounter][0] + ".svg", legendascaling)
