...
cities = [["Mexico City", "#CD0027", [15.0, 150.0], [15.0, 150.0]], ["New York", "#884DFF", [25.0, 160.0], [15.0, 150.0]],
          ["Dallas", "#884DFF", [25.0, 170.0], [15.0, 150.0]], ["Kansas City", "#884DFF", [25.0, 180.0], [15.0, 150.0]],
          ["Houston", "#884DFF", [25.0, 190.0], [15.0, 150.0]], ["Atlanta", "#884DFF", [25.0, 200.0], [15.0, 150.0]],
          ["Los Angeles", "#884DFF", [25.0, 210.0], [15.0, 150.0]], ["Seattle", "#884DFF", [25.0, 220.0],[15.0, 150.0]],
          ["San Francisco", "#884DFF", [25.0, 20.0],[15.0, 150.0]], ["Philadelphia", "#884DFF", [25.0, 270.0],[15.0, 150.0]],
          ["Miami", "#884DFF", [25.0, 230.0],[15.0, 150.0]], ["Boston", "#884DFF", [25.0, 240.0], [15.0, 150.0]],
          ["Vancouver", "#884DFF", [25.0, 250.0], [15.0, 150.0]], ["Monterrey", "#884DFF", [25.0, 260.0],[15.0, 150.0]], 
          ["Toronto", "#884DFF", [25.0, 100.0], [15.0, 150.0]], ["Guadalajara", "#884DFF", [30.0, 90.0], [15.0, 150.0]]]
left_padding = 0
bottom_padding = 0
width = 595
height = 842
...
for i in range(len(cities)):
    ...
    my_canvas.drawString(float(cities[i][2][0]) + 5.0, float(cities[i][2][1]), cities[i][0])
