...
renderPDF.draw(scaleSVG("SVG/Bronze_cup.svg", scalecup), my_canvas, xcup, 142)
renderPDF.draw(scaleSVG("SVG/Silver_cup.svg", scalecup), my_canvas, xcup, 162)
renderPDF.draw(scaleSVG("SVG/Gold_cup.svg", scalecup), my_canvas, xcup, 182)
