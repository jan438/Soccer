...
cities = [["Mexico City", [87.0, 168.0], [87.0, 171.0]],
          ...
          ["Houston", [102.0, 193.0], [104.0, 193.0]],
...
mapversie = "Russia"
colwidthgame = 72
pcol1 = HexColor("#b4e9ff") # poule light blue
...
for i in range(48):
    ...
    teamcounter += 1
renderPDF.draw(scaleSVG("SVG/Bronze_medal.svg", 0.06), my_canvas, 520, 140)
renderPDF.draw(scaleSVG("SVG/Silver_medal.svg", 0.06), my_canvas, 520, 160)
renderPDF.draw(scaleSVG("SVG/Gold_medal.svg", 0.06), my_canvas, 520, 180)
renderPDF.draw(scaleSVG("SVG/Bronze_cup.svg", 0.02), my_canvas, 520, 140)
renderPDF.draw(scaleSVG("SVG/Silver_cup.svg", 0.02), my_canvas, 520, 160)
renderPDF.draw(scaleSVG("SVG/Gold_cup.svg", 0.02), my_canvas, 520, 180)
my_canvas.setFont(socfont, 12)
my_canvas.setFillColor(HexColor("#ffffff"))
my_canvas.drawString(538,143,"England")
my_canvas.drawString(538,163,"Argentina")
my_canvas.drawString(538,183,"Spain")
my_canvas.save()
key = input("Wait")
