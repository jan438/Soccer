...
os.chdir(path)
file_to_open = "Data/WC2026A3.csv"
...
eventcal = "Calendar/WK2026ics.ics"
...
#mapversie = "GB"
mapversie = "Russia"
colwidthgame = 102          # 8 ^ 102 816 width A3 842
...
my_canvas = canvas.Canvas("PDF/WorldCup2026icsA3.pdf", pagesize = A3)
width, height = A3
...
drawing = scaleSVG('FIFA.svg', 0.15)
renderPDF.draw(drawing, my_canvas, 75, 1050)
...
for poule in range(12):
    ...
    for team in range(teamspp):
        ...
        if nameinlogo[0] == "n":
            ...
            my_canvas.drawString(left_margin + 12 + poule * poule_width + 0.5 * (maxnamewidth - namewidth), pouleland_y - 5, nationsdata[teamcounter][0])
...
for j in range(13):
    ...
    for i in range(8):
        ...
        if category == "3" or category == "1" or category == "Q" or category == "S" or category == "T" or category == "Z":
            ...
            my_canvas.setFont(socfontbold, 10)
            my_canvas.setFillColor(HexColor("#ffffff"))
        ...
        my_canvas.drawString(left_margin + i * colwidthgame + 30, gameline - 2, opponent2)
